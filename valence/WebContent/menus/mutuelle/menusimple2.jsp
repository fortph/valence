...
<div id="main-menu-container">
	<ul id="menu">
		...
		<li><a
			href="/valence/jsp/mutuelle/historiqueparpersonne.jsp?numero=<%=numero%>">Historique</a></li>	
		<li><a
			href="/valence/jsp/mutuelle/nouveau.jsp?numero=<%=numero%>">Nouvelle Proposition</a></li>	
