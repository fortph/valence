...
<%
	String idcont = request.getParameter("numcontrat");
AvenantCDIDAO ccdidao=new AvenantCDIDAO();
AvenantCDI contrat=ccdidao.findByID(Integer.parseInt(idcont));
int id_pers=contrat.getContrat().getIdentite().getId_IDE();
