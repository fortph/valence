...
<body>
	...
	<ul id="menu">
		...
		<li><a href="/valence/jsp/sap/avenantcontrat/modifieravenant.jsp?numcontrat=<%=numcontrat%>">Modifier Avenant </a>

		</li>
		
	<li><a href="/valence/jsp/sap/pdf/avenantcontrat.jsp?numcontrat=<%=numcontrat%>"  target="_blank" >Impression </a>
