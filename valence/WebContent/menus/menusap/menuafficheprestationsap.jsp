...
<body>
	...
	<ul id="menu">
		...
		<li><a href="/valence/jsp/sap/prestation/modifierprestation.jsp?prestation=<%=numcontrat%>">Modifier Prestation </a>

		</li>
		<li><a href="/valence/jsp/sap/prestationavenant/nouveau.jsp?prestation=<%=numcontrat%>">Nouvel Avenant </a>
