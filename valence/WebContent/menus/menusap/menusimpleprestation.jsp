...
<%
String idcont = request.getParameter("prestation");
PrestationCDIDAO ccdidao=new PrestationCDIDAO();
PrestationCDI contrat=ccdidao.findByID(Integer.parseInt(idcont));
int id_pers=contrat.getIdentite().getId_IDE();
