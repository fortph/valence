...
<div id="main-menu-container">
	<ul id="menu">
		...
		<li><a href="/valence/jsp/sap/contrat/nouveau.jsp?personne=<%=id_pers%>">Nouveau Contrat </a>
		<!-- 
		<li><a href="/valence/jsp/sap/prestation/nouvelle.jsp?personne=<%=id_pers%>">Nouvelle Prestation </a>
		-->
