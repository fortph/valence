...
<%
	...
	FicheRMI fichermi=rmidao.recupereDerniereFicheRMI(pers);
...
<body>
	...
	<ul id="menu">
		...
		<li><a href="/valence/jsp/rmi_rsa/fiches/modifierfichermi.jsp?fiche=<%=fichermi.getId_rmi() %>&numero=<%=numero%>">Modifier</a>

		</li>

		<li><a href="/valence/jsp/rmi_rsa/contrat/nouveau.jsp?fiche=<%=fichermi.getId_rmi()%>&personne=<%=numero%>">Nouveau
				Contrat </a></li>
		<!-- <li><a
			href="/valence/jsp/rmi_rsa/pdf/evaluation.jsp?numero=<%=numero%>">Imprimer
				évaluation pro</a></li>
-->
	</ul>
