...
<%
	...
	String lecontrat=request.getParameter("contrat");
...
<body>
	...
	<ul id="menu">
		...
		<li><a href="/valence/jsp/rmi_rsa/fiches/fichermisuite.jsp?personne=<%=numero%>" >Fiche RSA</a>

		</li>

		<li><a href="/valence/jsp/rmi_rsa/fiches/modifierfichecli.jsp?contrat=<%=lecontrat%>&personne=<%=numero%>">Modifier
				Fiche </a></li>
			</ul>
