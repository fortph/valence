...
<%
	...
	AvenantPrestationCDIDAO contdao=new AvenantPrestationCDIDAO();
	AvenantPrestationCDI contrat=contdao.findByID(Integer.parseInt(numcontrat));
	int idemployeur=contrat.getPrestation().getEmployeur().getId_employeur();
	%>
...
<div id="main-menu-container">
	<ul id="menu">
		...
		<li><a
			href="/valence/jsp/employeurs/affichage.jsp?numero=<%=idemployeur%>">Fiche</a>
			</li>
