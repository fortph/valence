...
<body>
	<%
		...
		String affichedatefin=sdform.format(dfin);
		 ...
		 affiche="LISTE SALARIES EN CONTRAT SUR LA PERIODE DU "+affichedatedeb+" AU "+affichedatefin;
		 			
		avenants=avdao.listeAvenantSurPeriode(ddeb, dfin);
		contrats=codao.contratAIsurPeriode(ddeb, dfin);
	 ...
	 affiche="LISTE SALARIES EN CONTRAT SUR LA PERIODE DU "+affichedatedebut+" AU "+affichedatefin;
	...
	<div id="body">
		...
		<form name="form1" method="post" action="/valence/controleur">
			<input type="hidden" name="action" value="aisalariesencontratsur" />
			<table class="table4">
				<tr>
					<td>Du :</td>
		...
		<table class="table1">
			...
			<tr>
				<td class="petit"><a
					href="/valence/controleur?action=aisalariesencontratsur&a=-2">M-2</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=aisalariesencontratsur&a=-1">M-1</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=aisalariesencontratsur&a=0">M</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=aisalariesencontratsur&a=1">M+1</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=aisalariesencontratsur&a=2">M+2</a></td>
