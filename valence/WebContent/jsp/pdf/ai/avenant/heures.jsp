...
<%
	String numerocontrat = request.getParameter("avenant");
	...
	/*float moissmiic=new SmicDAO().moisSmicAvenant(dmois,numerocontrat);*/
	//System.out.println("mois du smiic ="+moissmiic);
	...
	Avenant avenant = avedao.findByID(Integer.parseInt(numerocontrat));
	...
	<%
		...
		try {
			...
			PdfPCell qualite1 = new PdfPCell(new Phrase(
					" Lieu d\'exécution :  " + avenant.getLieu(),
					normalgras2));
			...
			PdfPCell qual3 = new PdfPCell(new Phrase(
					" Date de mise à disposition : "
							+ sdf.format(avenant.getDatedeb()), normalgras2));
			...
			PdfPCell rem032 = new PdfPCell(new Phrase(decimalformat.format(avenant.getPanier())
					+ " €", normalgras));
			rem032.setBorder(0);
			...
			PdfPCell rem062 = new PdfPCell(new Phrase(decimalformat.format(avenant.getDivers())
					+ " €", normalgras));
			rem062.setBorder(0);
