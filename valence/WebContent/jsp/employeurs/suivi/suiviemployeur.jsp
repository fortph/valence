...
<body>
	...
	<div id="body">
		...
		<br>
		<h3 id="creation">CREATION SUIVI EMPLOYEUR</h3>
		<br>
		<hr>
		<br>
		...
		<form method="post" name="form1" action="/valence/controleur">
			<input type="hidden" name="action" value="savesuiviemployeur" />
			...
			<table class="table1">
				...
				<tr>
					...
					<td><select name="utilisateurs" id="utilisateurs"
						onfocus="afficheCapUtilisateurs();"></select></td>
				...
				<br>
			<div id="fin">
				<input type="button" value="Enregistrer" onclick="valider(form1);" /> <input
