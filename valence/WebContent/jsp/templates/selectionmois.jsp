...
<link rel="stylesheet"
	href="/valence/javascript/css/jquery.drelevehoraireSAPataTables_themeroller.css">
...
<body>
	...
	<div id="body">
		...
		<br>
		<div id="creation"><%=titre1 %></div>
		<br> <br>
		<p class="centre3">Veuillez sélectionner le mois et l'année
			désirée</p>
		<br>
		<form name="form1" method="post" target="_blank" action="/valence/controleur">
			...
			<table class="table1">
				...
				<tr>
					...
					<option
								<%if (selectionannee == anplus)
				out.println("selected='selected'");%>><%=anplus%></option>
							<option
