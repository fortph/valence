...
<body>
	...
	<div id="creation">STATISTIQUES PAR ANNEE CIVILE</div>
		<h4>Sélection de l'année CIVILE sur laquelle calculer les statistiques</h4>
		
		
		<form method="post" name="form1" action="/valence/controleur">
			<input type="hidden" name="action" value="statformationpourcentcivil" />
			<table>
				<tr>
					<td><label for="datedebutrech">Date de Début
