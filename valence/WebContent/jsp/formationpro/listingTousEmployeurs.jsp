...
FormationProEmployeurDAO empdao = new FormationProEmployeurDAO();
	List<FormationProEmployeur> liste = empdao.findAll();
if(liste.size()!=0){
...
<body>
	...
	<p><%@ include file='/menus/menugeneral/menu.html' %></p><br>
		<div id="creation">LISTE DES EMPLOYEURS</div>
		<br>
		<h4><%=liste.size()%>
		...
		<table id="tablelisteemployeurss"align="center"width="1000" class="display"  cellpadding="0" cellspacing="0" >
			<thead>
				<tr>
					<th>NOM</th>
					<th>ADRESSE</th>
			...
			<tbody>
				...
				<tr>
					...
					<td><% if(liste.get(i).getAdresse()!=null)out.println(liste.get(i).getAdresse()); %></td>
					<td><% if(liste.get(i).getCp()!=null)out.println(liste.get(i).getCp());  %></td>
					<td><% if(liste.get(i).getVille()!=null)out.println(liste.get(i).getVille()); %></td>
					<td><% if(liste.get(i).getTel1()!=null)out.println(liste.get(i).getTel1()); %></td>
					<td><% if(liste.get(i).getTel2()!=null)out.println(liste.get(i).getTel2());  %></td>
