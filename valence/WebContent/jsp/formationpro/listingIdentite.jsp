<%@page
	import="dao.imp.identite.*,dao.imp.formationpro.*, beans.identite.*,beans.formationpro.*,java.sql.*, java.util.*"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<link rel="stylesheet" href="/valence/css/formationpro/affichage.css">
...
<%
	List<Identite> liste = (List<Identite>) request
			.getAttribute("resultset");
	FormationProInscriptionDAO formdao = new FormationProInscriptionDAO();
	List<FormationProInscription> pre = null;
...
<div id="body">
	...
	<%
		...
		<tr>
			...
			<td><center><a
				href="/valence/jsp/formation/modifierInscritformation.jsp?numero=<%=tamp.getId_IDE()%>"><img
					src="images/bleu/mod.png" /></a></center></td>
			<td>
				<%
					pre = formdao.findByIdentite(tamp);
							
							
				%><button id="enregistre"
					
					onclick="self.location.href='/valence/jsp/formationpro/inscription.jsp?numero=<%=tamp.getId_IDE()%>'">Inscription</button>
			</td>
