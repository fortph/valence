...
String rechercherpersonne="PYRAMIDE : rechercher une personne";
...
String  recherchernom="formationrecherchernom";
String libelle2="Sinon, taper sur les premières lettres (au moins 3) de son nom pour une recherche plus ciblée";
String majsp="formation/preinscription.jsp";
String monscript="autocompletevisiteurspyramide.js";
