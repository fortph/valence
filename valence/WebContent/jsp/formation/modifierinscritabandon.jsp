...
<script type="text/javascript">
	...
	<%	//on recupere le numero d'inscription a la formation
		...
		//on recupere la formation concernée		
...
<body onload="recupererlisteOrganimeParFormation(),recupererdatedebutFormation();">
	...
	<p><%@ include file='/menus/menupyramide/menupyramidemini.jsp' %></p><br>
		<div id="creation">	Modification de l'inscription  pour
			<%=nom%></div>
		<br>
		...
		<form method="post" action="/valence/controleur">
			...
			<table class="fond3">
				...
				<td><input type="text" id="dateabandonformation" name="dateabandonformation" /></td>
					...
					<label for="raison" >Raison de l'abandon:</label>
