...
<script type="text/javascript">
	function valider(formulaire) {
		...
		if (nom == "") {
			...
			attentionComplet(" Un thème de formation doit être renseigné et doit être unique !!!!");
			return false;
		}
...
<div id="body">
		...
		if (id!=null ){
			if( !id.equals("0")){		
						out.println("<p class='ok'>Le thème "+nom+"  a été créé.</p>");
			
		}
			else
				out.println("<p class='ok'>Le thème "+nom+" existe déjà .<br> Veuillez modifier SVP...</p>");
		}
