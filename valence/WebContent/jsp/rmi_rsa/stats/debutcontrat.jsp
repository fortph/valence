...
<title>Liste debuts contrats RSA</title>
</head>
...
<body>
	<%
		...
		Utilisateur ref = null;
			...
			if(datedebut==null &&  datefin==null && referent ==null ){
				...
				affiche="LISTE DES DEBUTS DE CONTRATS DU "+affichedatedeb+" AU "+affichedatefin;
		 
				listefiche=ficdao.contratRMICommenceParDates(ddeb, dfin,null);
		 		totalpersonnes=ficdao.totalPersonnesParDatesDebut(ddeb,dfin,ref);
		...
		// idem mois en cours avec un nom de referent
			...
			ref=null;
			 ...
			 listefiche=ficdao.contratRMICommenceParDates(ddeb, dfin,ref);
			 totalpersonnes=ficdao.totalPersonnesParDatesDebut(ddeb,dfin,ref); 
		...
		String affichedatefin=sdform.format(datedefin);
			 affiche="LISTE DES DEBUTS DE CONTRATS DU "+affichedatedebut+" AU "+affichedatefin;
			 if(referent!=null){
			 if (referent.equals("lac"))
					try {
						ref = utidao.findByName("Lacourt monique");
			 ...
			 listefiche=ficdao.contratRMICommenceParDates(datededeb, datedefin,ref);
			 totalpersonnes=ficdao.totalPersonnesParDatesDebut(datededeb,datedefin,ref); 
		}
	...
	<div id="body">
		...
		<form method="post" name="form1" action="/valence/controleur">
			<input type="hidden" name="action" value="rmilistecontratpardatedebut" />
			<table class="table4">
				<tr>
					<td>Du</td>
		...
		<table class="table1">
			<tr>
				<td class="quart"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=<%=a %>&referent=tous&datedebut=<%=datedebut%>&datefin=<%=datefin%>">Tous</a></td>
				<td class="quart"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=<%=a %>&referent=lac&datedebut=<%=datedebut%>&datefin=<%=datefin%>">Monique
						Lacourt</a></td>
				<td class="quart"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=<%=a %>&referent=nat&datedebut=<%=datedebut%>&datefin=<%=datefin%>">Nathalie</a></td>
				<td class="quart"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=<%=a %>&referent=phil&datedebut=<%=datedebut%>&datefin=<%=datefin%>">Philippe</a></td>
			</tr>
		</table>
		...
		<table class="table2">
			<tr>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=-12&referent=<%=referent%>">M-12</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=-11&referent=<%=referent%>">M-11</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=-10&referent=<%=referent%>">M-10</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=-9&referent=<%=referent%>">M-9</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=-8&referent=<%=referent%>">M-8</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=-7&referent=<%=referent%>">M-7</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=-6&referent=<%=referent%>">M-6</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=-5&referent=<%=referent%>">M-5</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=-4&referent=<%=referent%>">M-4</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=-3&referent=<%=referent%>">M-3</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=-2&referent=<%=referent%>">M-2</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=-1&referent=<%=referent%>">M-1</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=0&referent=<%=referent%>">M</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=1&referent=<%=referent%>">M+1</a></td>
				<td class="petit"><a
					href="/valence/controleur?action=rmilistecontratpardatedebut&a=2&referent=<%=referent%>">M+2</a></td>
